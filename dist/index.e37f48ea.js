...
const loadRecipe = async function(id) {
    try {
        ...
        // Temp error handling
        console.error(`${error}\u{1F937}\u{200D}\u{2642}\u{FE0F}\u{1F937}\u{200D}\u{2642}\u{FE0F}\u{1F937}\u{200D}\u{2642}\u{FE0F}`);
        throw error;
    }
};
...
const KEY = "63b6a726-ad00-4b26-a718-af2abbd6dcb1";
...
var _fractionalJs = require("../fractional.js");
var _fractionalJsDefault = parcelHelpers.interopDefault(_fractionalJs);
class RecipeView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkupIngredient(ing) {
      ...
      <li class="recipe__ingredient">
        ...
        <div class="recipe__quantity">${ing.quantity ? new (0, _fractionalJsDefault.default)(ing.quantity).toString() : ""}</div>
...
},{"./View.js":"5cUXS","url:../../img/icons.svg":"loVOp","../fractional.js":"4Jrpy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5cUXS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
},{}],"4Jrpy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Fractional {
    #floating;
    ...
    #main(number) {
        this.#isFloat(number) && (this.#floating = number.toString().split(".")[1]);
        if (this.#floating) {
        ...
        return this.#semplifyFraction = this.#semplifiedFraction(this.#numerator, this.#denominator);
    }
...
exports.default = Fractional;
Fractional.prototype.toString = function string() {
    const returnData = typeof this.result === "object" ? `${this.result.numerator}/${this.result.denominator}` : `${this.result}`;
    return returnData;
};
